...
<template>
  <div class="mail-list">
    ...
    <div class="ml-actions">
      ...
      <div class="ml-spacer" />
      <button
        class="btn btn-secondary btn-sm ml-delete-btn"
        :disabled="processing || deleting || selectedIds.size === 0"
        @click="emit('delete')"
      >
        {{ deleting ? '删除中…' : '删除所选' }}
      </button>
        ...
        <tbody>
          ...
          >
            ...
            <td class="col-subject">
              <div class="ml-subject" data-no-ui-translate>{{ m.subject || '(无主题)' }}</div>
              <div class="ml-meta">
...
.ml-delete-btn {
  color: var(--red-t);
  border-color: color-mix(in srgb, var(--red-t) 32%, var(--border));
}
