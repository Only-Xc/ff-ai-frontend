...
const EN: Record<string, string> = {
  '知识库': 'Knowledge Base',
  '按目录组织上传文件，内容将进入现有 AI 检索与关系图谱。': 'Organize files by folder for AI retrieval and knowledge graphs.',
  '刷新': 'Refresh',
  ...
  'PDF、Office、文本、HTML、JSON、图片，单文件不超过 50MB': 'PDF, Office, text, HTML, JSON, and images; 50 MB max per file',
  ...
  '检索实验室': 'Retrieval Lab',
  '对当前目录及全部子目录的已入库文件进行向量检索': 'Run vector retrieval across indexed files in this folder and all subfolders',
  ...
  '复制片段': 'Copy chunk',
  '详情': 'Details',
  '正在使用 text-embedding-v4 检索目录文件…': 'Searching folder files with text-embedding-v4…',
  ...
  '按目录、文件或邮件查看关系来源': 'View relationships from selected files or mail',
  ...
  '最近话题': 'Recent topics',
  '暂无记忆。随着对话进行，Agent 会记录关键信息。': 'No memory yet. The agent will retain important context as you chat.',
  ...
  '将删除工作台记录和知识索引，不会删除 IMAP 服务器中的原始邮件。': 'Workbench records and knowledge indexes will be deleted. Source mail on the IMAP server will not be deleted.',
  '已删除': 'Deleted',
  '封邮件': 'mail messages',
  '未找到': 'Not found',
  '删除失败': 'Delete failed',
  ...
  '基于 LightRAG 跨文档知识图谱，用自然语言探索邮件里的': 'Explore cross-document knowledge from files and mail using natural language',
  '客户、对接人、项目与内部负责人关系': 'Relationships among customers, contacts, projects, and owners',
  ...
  '🕐 最近话题': 'Recent topics',
  '关闭': 'Close',
  '基于邮件内容自动识别的项目、人员与组织关系': 'Projects, people, and organizations identified from knowledge sources',
  ...
  '请先在「邮件工作台」拉取邮件并导入到知识图谱，系统将自动识别项目信息。': 'Import mail in the workbench to identify project information automatically.',
  '删除项目': 'Delete project',
  ...
  '正在从知识图谱中提取邮件、人员、合同等关键信息': 'Extracting key mail, people, and contract information from the graph',
  '导入文件': 'Import files',
  '拉取邮件': 'Fetch mail',
  ...
  '密码仅用于 IMAP 登录，加密存储': 'The password is encrypted and used only for IMAP login',
  '如：工作邮箱': 'Example: work mailbox',
  '已保存的账号可删除，不影响已有数据': 'Deleting a saved account does not remove existing data',
  '＋ 保存账号': 'Save account',
  ...
  '① 选择本地邮件文件（.pst / .ost / .eml / .msg）并导入': 'Select local mail files and import them',
  '服务日志': 'Service logs',
...
const AR: Record<string, string> = {
  '知识库': 'قاعدة المعرفة',
  '按目录组织上传文件，内容将进入现有 AI 检索与关系图谱。': 'نظّم الملفات في مجلدات للبحث بالذكاء الاصطناعي ورسوم المعرفة.',
  '刷新': 'تحديث',
  ...
  'PDF、Office、文本、HTML、JSON、图片，单文件不超过 50MB': 'ملفات PDF وOffice والنصوص وHTML وJSON والصور؛ 50 ميغابايت للملف',
  ...
  '对当前目录及全部子目录的已入库文件进行向量检索': 'بحث متجهي في الملفات المفهرسة في هذا المجلد ومجلداته الفرعية',
  ...
  '复制片段': 'نسخ المقطع',
  '详情': 'التفاصيل',
  '正在使用 text-embedding-v4 检索目录文件…': 'جارٍ البحث في الملفات باستخدام text-embedding-v4…',
  ...
  '暂无记忆。随着对话进行，Agent 会记录关键信息。': 'لا توجد ذاكرة بعد. سيحتفظ الوكيل بالسياق المهم أثناء المحادثة.',
  ...
  '将删除工作台记录和知识索引，不会删除 IMAP 服务器中的原始邮件。': 'ستُحذف سجلات مساحة العمل وفهارس المعرفة، ولن يُحذف البريد الأصلي من IMAP.',
  '已删除': 'تم حذف',
  '封邮件': 'رسائل',
  '未找到': 'غير موجود',
  '删除失败': 'فشل الحذف',
  ...
  '基于 LightRAG 跨文档知识图谱，用自然语言探索邮件里的': 'استكشف المعرفة عبر الملفات والبريد باللغة الطبيعية',
  ...
  '🕐 最近话题': 'المواضيع الأخيرة',
  '关闭': 'إغلاق',
  '基于邮件内容自动识别的项目、人员与组织关系': 'مشاريع وأشخاص ومؤسسات مستخرجة من مصادر المعرفة',
  ...
  '请先在「邮件工作台」拉取邮件并导入到知识图谱，系统将自动识别项目信息。': 'استورد البريد في مساحة العمل لاكتشاف المشاريع تلقائيًا.',
  '删除项目': 'حذف المشروع',
  ...
  '正在从知识图谱中提取邮件、人员、合同等关键信息': 'جارٍ استخراج البريد والأشخاص والعقود من الرسم',
  '导入文件': 'استيراد ملفات',
  '拉取邮件': 'جلب البريد',
  ...
  '文件夹': 'مجلد',
  '📄 选择文件…（可多选）': 'اختر ملفات…',
  '① 选择本地邮件文件（.pst / .ost / .eml / .msg）并导入': 'اختر ملفات البريد المحلية واستوردها',
  '服务日志': 'سجلات الخدمة',
  ...
  observer = new MutationObserver((mutations) => {
    ...
    for (const mutation of mutations) {
      if (mutation.type === 'characterData') {
        ...
        if (knownSource && element.getAttribute(attribute) === t(knownSource)) continue
...
export function postPlatformRoute(route: RouteLocationNormalizedLoaded) {
...
export function installPlatformContext(app: App) {
  ...
  window.addEventListener('message', (event: MessageEvent<PlatformContextMessage>) => {
    if (
