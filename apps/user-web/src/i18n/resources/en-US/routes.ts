export default {
  ...
  'routes.mailgraph.title': 'Knowledge Base',
  'routes.mailgraph.chat': 'Knowledge Chat',
  'routes.mailgraph.dashboard': 'Analysis Overview',
  'routes.mailgraph.workbench': 'Mail Workbench',
  'routes.mailgraph.knowledge': 'Knowledge Files',
  'routes.mailgraph.graph': 'Knowledge Graph',
  'routes.mailgraph.settings': 'Knowledge Base Settings',
