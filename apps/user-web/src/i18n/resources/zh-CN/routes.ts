export default {
  ...
  'routes.platformApps.title': '平台应用',
  'routes.workflowChat.title': 'Workflow 应用',
  'routes.pluginCarrier.title': '插件应用',
  ...
  'routes.mailgraph.title': '知识库',
  'routes.mailgraph.chat': '知识对话',
  'routes.mailgraph.dashboard': '分析概览',
  'routes.mailgraph.workbench': '邮件工作台',
  'routes.mailgraph.knowledge': '知识文件',
  'routes.mailgraph.graph': '知识图谱',
  'routes.mailgraph.settings': '知识库设置',
