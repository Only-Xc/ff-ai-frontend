...
export const appRoutes: AppRouteObject[] = [
  ...
  },
  {
    handle: {
      ...
      titleKey: 'routes.groups.accessControl',
      icon: <TeamOutlined />,
      menuType: 'catalog',
      menuMode: 'submenu',
      navKey: 'rbac',
      navOrder: 7.1,
      hideInBreadcrumb: true,
      permissions: ['admin.roles.read', 'admin.users.read', 'admin.orgs.read'],
      permissionMode: 'any',
  ...
  },
  {
    handle: {
      ...
      titleKey: 'routes.groups.governance',
      icon: <SafetyCertificateOutlined />,
      menuType: 'catalog',
      menuMode: 'submenu',
      navKey: 'grc',
  ...
  {
    handle: {
      title: 'Stage Switch Management',
      titleKey: 'routes.groups.stageSwitch',
      icon: <SwapOutlined />,
      menuType: 'catalog',
      menuMode: 'submenu',
      navKey: 'stage-switch',
    ...
    children: [
      ...
      },
      {
        ...
        element: lazyLoad(
          () => import('@/pages/stage-switch/NotificationCenter'),
        ),
        handle: {
