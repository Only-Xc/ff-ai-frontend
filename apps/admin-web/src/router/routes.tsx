...
export const appRoutes: AppRouteObject[] = [
  ...
  {
    path: '/stage-switch/requests',
    element: lazyLoad(() => import('@/pages/stage-switch/RequestList')),
    handle: {
      title: 'Stage Switch',
      titleKey: 'routes.stageSwitch.requests.title',
      subtitleKey: 'routes.stageSwitch.requests.subtitle',
      icon: <SwapOutlined />,
      navKey: 'stage-switch-requests',
      navOrder: 12.5,
      hideInBreadcrumb: true,
      permission: 'admin.stage_switch.read',
      menuCode: 'menu.admin.stage_switch',
    },
  },
  {
    path: '/stage-switch/requests/:requestId',
    element: lazyLoad(() => import('@/pages/stage-switch/RequestDetail')),
    handle: {
      title: 'Stage Switch Detail',
      titleKey: 'routes.stageSwitch.requestDetail.title',
      navKey: 'stage-switch-requests',
      hideInMenu: true,
      permission: 'admin.stage_switch.read',
    },
  ...
  {
    path: '/stage-switch/templates',
    element: lazyLoad(() => import('@/pages/stage-switch/TemplateList')),
    handle: {
      title: 'Stage Switch Templates',
      titleKey: 'routes.stageSwitch.templates.title',
      subtitleKey: 'routes.stageSwitch.templates.subtitle',
      icon: <SettingOutlined />,
      navKey: 'stage-switch-templates',
      navOrder: 12.6,
      hideInBreadcrumb: true,
      permission: 'admin.stage_switch.templates.read',
      menuCode: 'menu.admin.stage_switch',
    },
  },
  {
    path: '/stage-switch/templates/:templateId',
    element: lazyLoad(() => import('@/pages/stage-switch/TemplateEditor')),
    handle: {
      title: 'Stage Switch Template Editor',
      titleKey: 'routes.stageSwitch.templateEditor.title',
      navKey: 'stage-switch-templates',
      hideInMenu: true,
      permission: 'admin.stage_switch.templates.read',
    },
  ...
  {
    path: '/stage-switch/notifications',
    element: lazyLoad(() => import('@/pages/stage-switch/NotificationCenter')),
    handle: {
      title: 'Stage Switch Notifications',
      titleKey: 'routes.stageSwitch.notifications.title',
      subtitleKey: 'routes.stageSwitch.notifications.subtitle',
      icon: <NotificationOutlined />,
      navKey: 'stage-switch-notifications',
      navOrder: 12.7,
      hideInBreadcrumb: true,
  ...
  },
  {
    ...
    element: lazyLoad(() => import('@/pages/service-catalog/CategoryTree')),
    handle: {
      title: 'Categories',
      titleKey: 'routes.serviceCatalog.categories.title',
      subtitleKey: 'routes.serviceCatalog.categories.subtitle',
      icon: <AppstoreOutlined />,
      navKey: 'service-catalog-categories',
      navOrder: 13,
      hideInBreadcrumb: true,
      permission: 'admin.service_catalog.read',
      menuCode: 'menu.admin.service_catalog',
    },
  },
  {
    path: '/service-catalog/services',
    element: lazyLoad(() => import('@/pages/service-catalog/ServiceList')),
    handle: {
      title: 'Services',
      titleKey: 'routes.serviceCatalog.services.title',
      subtitleKey: 'routes.serviceCatalog.services.subtitle',
      icon: <AppstoreOutlined />,
      navKey: 'service-catalog-services',
      navOrder: 13,
      hideInBreadcrumb: true,
      permission: 'admin.service_catalog.read',
      menuCode: 'menu.admin.service_catalog',
  ...
  {
    path: '/service-catalog/services/:serviceId',
    element: lazyLoad(() => import('@/pages/service-catalog/ServiceDetail')),
    handle: {
      title: 'Service Detail',
      titleKey: 'routes.serviceCatalog.serviceDetail.title',
      icon: <AppstoreOutlined />,
      navKey: 'service-catalog-services',
      hideInMenu: true,
      permission: 'admin.service_catalog.read',
  ...
  {
    path: '/service-catalog/services/:serviceId/edit',
    element: lazyLoad(() => import('@/pages/service-catalog/ServiceEdit')),
    handle: {
      title: 'Service Edit',
      titleKey: 'routes.serviceCatalog.serviceEdit.title',
      icon: <EditOutlined />,
      navKey: 'service-catalog-services',
      hideInMenu: true,
      permission: 'admin.service_catalog.manage',
    },
  },
  {
    path: '/service-catalog/import',
    element: lazyLoad(() => import('@/pages/service-catalog/ImportPanel')),
    handle: {
      title: 'Import',
      titleKey: 'routes.serviceCatalog.import.title',
      subtitleKey: 'routes.serviceCatalog.import.subtitle',
      icon: <UploadOutlined />,
      navKey: 'service-catalog-import',
      navOrder: 13,
      hideInBreadcrumb: true,
      permission: 'admin.service_catalog.import',
      menuCode: 'menu.admin.service_catalog',
    },
  },
  {
