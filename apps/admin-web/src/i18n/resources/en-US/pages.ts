export default {
  ...
  'pages.rbac.form.tenant': 'Tenant',
  'pages.rbac.form.tenantRequired': 'Please select a tenant',
  'pages.rbac.form.tenantHint':
    'The new user will be bound to the selected tenant.',
  'pages.rbac.form.tenantLockedHint':
    'Tenant administrators can only edit users within their own tenant.',
  'pages.rbac.form.tenantMigrateHint':
    'Switching tenants will migrate generic organization roles and drop old tenant-specific roles.',
  'pages.rbac.form.tenantPlaceholder': 'Select a tenant',
  'pages.rbac.form.tenantEmpty': 'No assignable tenants',
  'pages.rbac.columns.tenant': 'Tenant',
  'pages.rbac.messages.tenantLoadFailed': 'Failed to load tenant list',
  'pages.rbac.status.noTenant': 'Unassigned',
  ...
  'pages.production.status.none': 'Not Published',
  'pages.production.status.pre_production': 'Awaiting Approval',
  'pages.production.status.production': 'In Production',
  'pages.production.status.decommissioned': 'Decommissioned',
  'pages.production.status.PENDING': 'Pending',
  'pages.production.status.IN_REVIEW': 'In Review',
  'pages.production.status.APPROVED': 'Approved',
  'pages.production.status.REJECTED': 'Rejected',
  'pages.production.status.PRECHECK_BLOCKED': 'Pre-check Blocked',
  'pages.production.status.CANCELLED': 'Cancelled',
  'pages.production.queue.title': 'Production Approval',
  'pages.production.queue.approvalNo': 'Approval No.',
  'pages.production.queue.agent': 'Agent',
  'pages.production.queue.taskId': 'Task ID',
  'pages.production.queue.status': 'Status',
  'pages.production.queue.riskLevel': 'Risk Level',
  'pages.production.queue.qa': 'QA Result',
  'pages.production.queue.qaPassed': 'Passed',
  'pages.production.queue.qaFailed': 'Failed',
  'pages.production.queue.createdAt': 'Created At',
  'pages.production.queue.targetType': 'Type',
  'pages.production.queue.keywordPlaceholder':
    'Search by approval no. or agent',
  'pages.production.queue.intro':
    'Agents that have finished deployment and are awaiting production approval. The first release of a new agent requires approval.',
  'pages.production.queue.empty': 'No approval records',
  'pages.production.detail.title': 'Approval Detail',
  'pages.production.detail.subtitle':
    'Review QA / GRC evaluation and submit decision',
  'pages.production.detail.backToList': 'Back to List',
  ...
  'pages.production.detail.decidedAt': 'Decided At',
  'pages.production.detail.qaChecks': 'QA Checks',
  'pages.production.detail.qaChecksEmpty': 'No check items',
  'pages.production.detail.qaCheckType': 'Type',
  'pages.production.detail.qaCheckStatus': 'Status',
  'pages.production.detail.qaCheckDetail': 'Detail',
  'pages.production.detail.approvers': 'Approvers',
  'pages.production.detail.makeDecision': 'Make Decision',
  'pages.production.detail.cancel': 'Cancel Request',
  'pages.production.detail.cancelPrompt': 'Please enter cancel reason',
  'pages.production.detail.cancelTitle': 'Cancel Approval Request',
  'pages.production.detail.cancelReasonLabel': 'Cancel Reason',
  'pages.production.detail.cancelReasonRequired':
    'Please enter the cancel reason',
  'pages.production.detail.cancelSuccess': 'Approval cancelled',
  'pages.production.detail.reapply': 'Re-apply Rollout',
  'pages.production.detail.reapplySuccess': 'Rollout applied',
  'pages.production.detail.activationStatus': 'Activation Status',
  'pages.production.detail.activation.PENDING': 'Pending Activation',
  'pages.production.detail.activation.ACTIVE': 'Active',
  'pages.production.detail.activation.FAILED': 'Activation Failed',
  'pages.production.detail.decisionSuccess': 'Decision submitted',
  'pages.production.detail.notFound': 'Approval record not found',
  'pages.production.detail.decisionDecision': 'Decision',
  'pages.production.detail.decisionDecidedBy': 'Decided By',
  'pages.production.detail.decisionDecidedAt': 'Decided At',
  'pages.production.detail.decisionRationale': 'Rationale',
  'pages.production.detail.decisionsEmpty': 'No decision records',
  'pages.production.detail.workflowAppId': 'Workflow App ID',
  'pages.production.detail.viewWorkflowSnapshot': 'View Workflow Snapshot',
  'pages.production.detail.accessPolicy': 'Access Scope',
  'pages.production.detail.accessScope': 'Allowed Users',
  'pages.production.detail.accessScopeTenant': 'All Tenant Users',
  'pages.production.detail.accessScopeRoles': 'Specific Roles',
  'pages.production.detail.allowedRoles': 'Frozen Roles',
  'pages.production.detail.accessPolicyLegacy':
    'Access scope was not recorded for this legacy release',
  ...
  'pages.production.detail.imageObjectKey': 'Image Object Key',
  'pages.production.detail.artifactSha256': 'Artifact SHA-256',
  'pages.production.detail.artifactSize': 'Artifact Size',
  'pages.production.detail.buildFinishedAt': 'Build Finished At',
  'pages.production.detail.runtimeBaseImage': 'Runtime Base Image',
  'pages.production.detail.runtimeBaseDigest': 'Runtime Base Image Digest',
  'pages.production.detail.releaseId': 'Release ID',
  'pages.production.detail.flowId': 'Flow ID',
  'pages.production.detail.runtimeStatus': 'Runtime Status',
  'pages.production.detail.containerName': 'Container Name',
  'pages.production.detail.containerId': 'Container ID',
  'pages.production.detail.networkName': 'Docker Network',
  'pages.production.detail.networkAlias': 'Network Alias',
  'pages.production.detail.containerPort': 'Container Port',
  'pages.production.detail.runtimeImage': 'Runtime Image',
  'pages.production.detail.runtimeImageDigest': 'Runtime Image Digest',
  ...
  'pages.production.decisionDrawer.approve': 'Approve',
  'pages.production.decisionDrawer.reject': 'Reject',
  'pages.production.decisionDrawer.rationale':
    'Rationale (required, 1-2000 chars)',
  'pages.production.decisionDrawer.rationaleRequired': 'Please enter rationale',
  'pages.production.decisionDrawer.versionNotice':
    'Optimistic lock version: {{version}}',
  'pages.production.rollback.title': 'Rollback Production Agent',
  'pages.production.rollback.subtitle':
    'Stop production traffic while preserving deployment artifacts and approval history',
  'pages.production.rollback.warning':
    'Rollback is not a physical delete: deployment artifacts, approval history and QA results are retained.',
  'pages.production.rollback.agentIdLabel': 'Agent ID',
  'pages.production.rollback.reasonLabel': 'Rollback Reason',
  'pages.production.rollback.submit': 'Confirm Rollback',
  'pages.production.rollback.confirmTitle':
    'Confirm rollback? Production traffic will stop immediately.',
  'pages.production.rollback.success': 'Agent {{agent}} rolled back',
  'pages.serviceCatalog.actions.createCategory': 'New Category',
  'pages.serviceCatalog.actions.editCategory': 'Edit Category',
  'pages.serviceCatalog.actions.createService': 'New Service',
  'pages.serviceCatalog.actions.editService': 'Edit Service',
  'pages.serviceCatalog.actions.save': 'Save',
  'pages.serviceCatalog.actions.cancel': 'Cancel',
  'pages.serviceCatalog.actions.searchKeyword': 'Search services',
  'pages.serviceCatalog.actions.delete': 'Delete',
  'pages.serviceCatalog.actions.edit': 'Edit',
  'pages.serviceCatalog.actions.view': 'View',
  'pages.serviceCatalog.actions.back': 'Back',
  'pages.serviceCatalog.actions.manageCategories': 'Categories',
  'pages.serviceCatalog.actions.importFile': 'Import',
  'pages.serviceCatalog.actions.downloadTemplate': 'Download Template',
  'pages.serviceCatalog.actions.downloadTemplateExcel':
    'Download Template (.xlsx)',
  'pages.serviceCatalog.actions.downloadExport': 'Export Current Data',
  'pages.serviceCatalog.actions.uploadExcel': 'Upload Excel',
  'pages.serviceCatalog.actions.dragHere': 'Drag file here',
  'pages.serviceCatalog.actions.supportXlsx': 'Only .xlsx supported',
  'pages.serviceCatalog.actions.confirmDelete': 'Confirm delete?',
  'pages.serviceCatalog.actions.confirmDeleteDesc':
    'This cannot be undone. Categories with children or services cannot be deleted.',
  'pages.serviceCatalog.actions.createRootCategory': 'New Root Category',
  ...
  'pages.serviceCatalog.actions.parentCategory': 'Parent Category',
  'pages.serviceCatalog.actions.parentCategoryPlaceholder':
    'Leave empty for root category',
  'pages.serviceCatalog.actions.addNode': 'Add Node',
  'pages.serviceCatalog.actions.editNode': 'Edit Node',
  'pages.serviceCatalog.actions.addSystem': 'Add System',
  'pages.serviceCatalog.actions.editSystem': 'Edit System',
  'pages.serviceCatalog.actions.addAgentLink': 'Add Link',
  'pages.serviceCatalog.actions.editAgentLink': 'Edit Link',
  'pages.serviceCatalog.actions.addMaterial': 'Add Material',
  'pages.serviceCatalog.actions.editMaterial': 'Edit Material',
  'pages.serviceCatalog.actions.optionalPlaceholder': 'Optional',
  'pages.serviceCatalog.actions.emptyAgentHint':
    'No agent links yet. Click the button above to add one.',
  'pages.serviceCatalog.actions.active': 'Active',
  'pages.serviceCatalog.actions.inactive': 'Inactive',
  'pages.serviceCatalog.columns.name': 'Name',
  'pages.serviceCatalog.columns.code': 'Code',
  'pages.serviceCatalog.columns.status': 'Status',
  'pages.serviceCatalog.columns.sortOrder': 'Order',
  'pages.serviceCatalog.columns.serviceLevel': 'Level',
  'pages.serviceCatalog.columns.categoryCode': 'Category',
  'pages.serviceCatalog.columns.nodeType': 'Node Type',
  'pages.serviceCatalog.columns.estimatedDuration': 'Est. Minutes',
  'pages.serviceCatalog.columns.systemType': 'System Type',
  'pages.serviceCatalog.columns.sequence': 'Seq.',
  'pages.serviceCatalog.columns.handlerRole': 'Handler Role',
  'pages.serviceCatalog.columns.materials': 'Materials',
  'pages.serviceCatalog.columns.materialType': 'Material Type',
  'pages.serviceCatalog.columns.agentId': 'Agent ID',
  'pages.serviceCatalog.columns.linkType': 'Link Type',
  'pages.serviceCatalog.columns.taskId': 'Task ID',
  'pages.serviceCatalog.columns.interfaceDesc': 'Interface Description',
  'pages.serviceCatalog.columns.templatePath': 'Template Path',
  'pages.serviceCatalog.columns.description': 'Description',
  'pages.serviceCatalog.columns.organization': 'Organization',
  'pages.serviceCatalog.columns.owner': 'Service Owner',
  'pages.serviceCatalog.columns.actions': 'Actions',
  'pages.serviceCatalog.tabs.overview': 'Overview',
  'pages.serviceCatalog.tabs.nodes': 'Process Nodes',
  'pages.serviceCatalog.tabs.systems': 'Related Systems',
  'pages.serviceCatalog.tabs.agentLinks': 'Agent Links',
  'pages.serviceCatalog.messages.created': 'Created',
  'pages.serviceCatalog.messages.updated': 'Updated',
  'pages.serviceCatalog.messages.deleted': 'Deleted',
  'pages.serviceCatalog.messages.saved': 'Saved',
  'pages.serviceCatalog.messages.imported': 'Imported ({{summary}})',
  'pages.serviceCatalog.messages.importFailed':
    'Import failed, please check Excel',
  'pages.serviceCatalog.messages.activated': 'Activated',
  'pages.serviceCatalog.messages.deactivated': 'Deactivated',
  'pages.serviceCatalog.messages.createFailed': 'Create failed',
  'pages.serviceCatalog.messages.updateFailed': 'Update failed',
  'pages.serviceCatalog.messages.deleteBlocked':
    'Delete failed: category has children or services',

  // Workflow Console (spec: Workflow platform apps & admin patch)
  'pages.workflowAdmin.layout.title': 'Workflow Console',
  'pages.workflowAdmin.layout.subtitle':
    'Cross-tenant / single-tenant operations view',
  'pages.workflowAdmin.menu.dashboard': 'Dashboard',
  'pages.workflowAdmin.menu.apps': 'Workflow Apps',
  'pages.workflowAdmin.menu.tenants': 'Visible Tenants',
  'pages.workflowAdmin.scope.global': 'Global view',
  'pages.workflowAdmin.scope.tenant': 'Current tenant view',
  'pages.workflowAdmin.common.refresh': 'Refresh',
  'pages.workflowAdmin.metrics.total_workflows': 'Total Workflows',
  'pages.workflowAdmin.metrics.published_workflows': 'Published Workflows',
  'pages.workflowAdmin.metrics.total_runs': 'Total Runs',
  'pages.workflowAdmin.metrics.failed_runs': 'Failed Runs',
  'pages.workflowAdmin.metrics.error_rate': 'Error Rate',
  'pages.workflowAdmin.dashboard.title': 'Workflow Console',
  'pages.workflowAdmin.dashboard.subtitle':
    'Cross-tenant / single-tenant Workflow operations metrics',
  'pages.workflowAdmin.apps.title': 'Workflow Apps',
  'pages.workflowAdmin.apps.subtitle':
    'Cross-tenant Workflow app management (only system_admin can cross tenants; tenant_admin sees own)',
  'pages.workflowAdmin.apps.name': 'Name',
  'pages.workflowAdmin.apps.orgId': 'Tenant ID',
  'pages.workflowAdmin.apps.status': 'Status',
  'pages.workflowAdmin.apps.catalogStatus': 'Catalog Status',
  'pages.workflowAdmin.apps.updatedAt': 'Updated At',
  'pages.workflowAdmin.apps.description': 'Description',
  'pages.workflowAdmin.apps.searchPlaceholder': 'Search app name',
  'pages.workflowAdmin.apps.empty': 'No Workflow apps',
  'pages.workflowAdmin.tenants.title': 'Visible Tenants',
  'pages.workflowAdmin.tenants.subtitle':
    'system_admin sees all tenants; tenant_admin sees only its own',
  'pages.workflowAdmin.tenants.name': 'Tenant Name',
  'pages.workflowAdmin.tenants.code': 'Tenant Code',
  'pages.workflowAdmin.tenants.id': 'Tenant ID',
  'pages.workflowAdmin.tenants.workflowAppCount': 'Workflow Apps',
  'pages.workflowAdmin.tenants.empty': 'No visible tenants',
  'pages.workflowAdmin.tenants.tenantOnlyHint':
    'You are a tenant admin and can only see your own tenant; contact platform super admin for cross-tenant view',
  'pages.workflowAdmin.tenantPicker.placeholder': 'Select tenant',
  'pages.workflowAdmin.tenantPicker.all': 'All Tenants',
  'pages.workflowAdmin.tenantPicker.tenantOnly': 'Current Tenant',
  'pages.workflowAdmin.status.draft': 'Draft',
  'pages.workflowAdmin.status.pending_approval': 'Pending Approval',
  ...
  'pages.flowise.savedDraft': 'Saved Draft',
  'pages.flowise.frozenVersion': 'Frozen Version v{{version}}',
  'pages.flowise.graphLoadError': 'Failed to load workflow graph',
  'pages.flowise.emptyGraph': 'No workflow graph',
  'pages.flowise.canvasAriaLabel': 'Read-only workflow canvas',
  'pages.flowise.loadingSession': 'Loading read-only canvas...',
  'pages.flowise.sessionError': 'Failed to load read-only canvas',
}
