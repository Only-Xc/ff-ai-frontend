export default {
  ...
  'pages.rbac.form.tenantHint': 'The new user will be bound to the selected tenant.',
  'pages.rbac.form.tenantLockedHint': 'Tenant administrators can only edit users within their own tenant.',
  'pages.rbac.form.tenantMigrateHint': 'Switching tenants will migrate generic organization roles and drop old tenant-specific roles.',
  ...
  'pages.production.queue.keywordPlaceholder': 'Search by approval no. or agent',
  'pages.production.queue.intro': 'Agents that have finished deployment and are awaiting production approval. The first release of a new agent requires approval.',
  'pages.production.queue.empty': 'No approval records',
  'pages.production.detail.title': 'Approval Detail',
  'pages.production.detail.subtitle': 'Review QA / GRC evaluation and submit decision',
  ...
  'pages.production.detail.cancelReasonRequired': 'Please enter the cancel reason',
  ...
  'pages.production.decisionDrawer.rationale': 'Rationale (required, 1-2000 chars)',
  'pages.production.decisionDrawer.rationaleRequired': 'Please enter rationale',
  'pages.production.decisionDrawer.versionNotice': 'Optimistic lock version: {{version}}',
  'pages.production.rollback.title': 'Rollback Production Agent',
  'pages.production.rollback.subtitle': 'Stop production traffic while preserving deployment artifacts and approval history',
  'pages.production.rollback.warning': 'Rollback is not a physical delete: deployment artifacts, approval history and QA results are retained.',
  ...
  'pages.production.rollback.confirmTitle': 'Confirm rollback? Production traffic will stop immediately.',
  ...
  'pages.serviceCatalog.actions.downloadTemplateExcel': 'Download Template (.xlsx)',
  ...
  'pages.serviceCatalog.actions.confirmDeleteDesc': 'This cannot be undone. Categories with children or services cannot be deleted.',
  'pages.serviceCatalog.actions.createRootCategory': 'New Root Category',
  'pages.serviceCatalog.actions.emptyHint': 'No categories yet. Create a root category to get started.',
  'pages.serviceCatalog.actions.codePattern': 'Only letters, digits, underscores and hyphens allowed',
  'pages.serviceCatalog.actions.parentCategory': 'Parent Category',
  'pages.serviceCatalog.actions.parentCategoryPlaceholder': 'Leave empty for root category',
  ...
  'pages.serviceCatalog.actions.emptyAgentHint': 'No agent links yet. Click the button above to add one.',
  ...
  'pages.serviceCatalog.messages.importFailed': 'Import failed, please check Excel',
  ...
  'pages.serviceCatalog.messages.deleteBlocked': 'Delete failed: category has children or services',

  // Workflow Console (spec: Workflow platform apps & admin patch)
  'pages.workflowAdmin.layout.title': 'Workflow Console',
  'pages.workflowAdmin.layout.subtitle': 'Cross-tenant / single-tenant operations view',
  ...
  'pages.workflowAdmin.dashboard.subtitle': 'Cross-tenant / single-tenant Workflow operations metrics',
  'pages.workflowAdmin.apps.title': 'Workflow Apps',
  'pages.workflowAdmin.apps.subtitle': 'Cross-tenant Workflow app management (only system_admin can cross tenants; tenant_admin sees own)',
  ...
  'pages.workflowAdmin.tenants.subtitle': 'system_admin sees all tenants; tenant_admin sees only its own',
  ...
  'pages.workflowAdmin.detail.title': 'App Detail',
  'pages.workflowAdmin.detail.canvas': 'Canvas (Read-only)',
  'pages.workflowAdmin.detail.noCanvas': 'No canvas data',
